...
| [Move scoring](move-scoring.md) | Explains how the AI scores moves and chooses what to use each turn. |
| [Move scoring reference](move-scoring-reference.md) | An extensive list of score conditions used for specific moves. |
